<template>
  ...
  <div
    ...
    "
    class="fixed inset-y-0 left-0 z-30 w-64 overflow-y-auto transition duration-300 transform bg-primary lg:translate-x-0 lg:static lg:inset-0 rounded-r-lg"
  >
    <div class="flex items-center justify-center mt-8">
      <div class="flex items-center">
        <span class="text-2xl font-semibold text-white">Blu</span>
      </div>
    </div>
    <nav class="mt-10">
      <router-link
      ...
      >
        ...
        <span class="mx-3">{{ t("appointments") }}</span>
      </router-link>
      <router-link
        class="flex items-center px-6 py-2 mt-4 text-gray-200 hover:bg-primary-dark hover:bg-opacity-25 hover:text-white"
        to="/patients"
